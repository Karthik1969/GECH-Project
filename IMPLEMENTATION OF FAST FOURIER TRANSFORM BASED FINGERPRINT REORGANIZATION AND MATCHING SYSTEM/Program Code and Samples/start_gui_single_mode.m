...
FigWin = figure('Position',[50 -50 650 500],...
   'Name','Fingerprint Recognition - Emgineering Dept',...
   'NumberTitle','off',...
...
Text2 = uicontrol(FigWin,...
   ...
   'String','Fingerprint Recognition - Engineering Dept');
...
Text2 = uicontrol(FigWin,...
   ...
   'BackgroundColor',[ 0.741176470588235 0.725490196078431 0.658823529411765 ],...
   'HorizontalAlignment','right', ...
   'String','Fingerprint Verification - Engineering Dept');
...
text51='hough transform point extraction';
h=uicontrol(FigWin,...
   'Style','pushbutton',...
...
h=uicontrol(FigWin,...
   'Style','pushbutton',...
	...
	'String','Remove spurious minutia',...
   'Callback',...
